    ...
    <div class="col-md-12">
        <div class="x_panel">
            ...
            {!! Form::open(array('route' => 'record.create','id' => 'AddForm','class'=>'form-horizontal form-label-left')) !!}
                ...
                {!! Form::hidden('cate_id',$cateInfo->id) !!}
                <div class="form-group">
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-12">
                        <input class="form-control col-md-7 col-xs-12" id="title" name="title" required="required" type="text" data-parsley-id="7614"><ul class="parsley-errors-list" id="parsley-id-7614"></ul>
                    </div>
                </div>
               ...
               <div class="form-group">
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-12">
                        <textarea class="form-control col-md-7 col-xs-12" id="content" name="content" required="required" type="text" data-parsley-id="7614" rows="80" cols="20"></textarea><ul class="parsley-errors-list" id="parsley-id-7614"></ul>
                    </div>
                </div>
